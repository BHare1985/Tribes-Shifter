...
setCommanderChatMenu("");
   ...
   setCommanderChatMenu("eDeploy");
		setCommanderChatMenu("eDeploy\\sSensor");
			addCommand("pPulse sensor", 2, "Deploy pulse sensor at waypoint ", "deppuls");   // modified by Werewolf
			addCommand("jJammer", 2, "Deploy sensor jammer at waypoint ", "depjamr");   // modified by Werewolf
			addCommand("mMotion sensor", 2, "Deploy motion sensor at waypoint ", "depmot");   // modified by Werewolf
			addCommand("cCamera", 2, "Deploy camera at waypoint ", "depcam");   // modified by Werewolf
		setCommanderChatMenu("eDeploy\\aObject");
			addCommand("aAmmo", 2, "Deploy Ammo Station ", "depamo");   // modified by Werewolf
			addCommand("iInventory", 2, "Deploy Inventory Station", "depinv");   // modified by Werewolf
			addCommand("tTurret", 2, "Deploy Turret ", "deptur");   // modified by Werewolf
			addCommand("bBeacon", 2, "Deploy beacon at waypoint ", "depbecn");   // modified by Werewolf
		setCommanderChatMenu("eDeploy");
		addCommand("vA.P.C.", 2, "Pilot APC to waypoint ", "pilot");   // modified by Werewolf
