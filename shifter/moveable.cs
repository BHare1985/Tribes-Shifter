...
function Elevator::onCollision(%this, %object)
{
	...
	{
		if (GameBase::getTeam(%this) == GameBase::getTeam(%object) || %this.noTeam != "" || GameBase::getTeam(%this) == -1 || (%armor == "spyarmor") || (%armor == "spyfemale"))
		{
...
$DoorScale[$EqualizerDamageType] = 1.0;
$DoorScale[$IDamageType] = 1.0;
